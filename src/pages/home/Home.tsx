      ...
      <div className="max-w-6xl mx-6 md:mx-14 pt-3">
        ...
        <section>
          ...
          <Card
            ...
            buttons={[
              {
                text: formatMessage({ id: 'home.card.volunteer.button.accommodation' }),
                color: 'bg-teal-800',
          ...
          <div className="flex flex-1 flex-wrap justify-between">
            <div>
              <div className="flex flex-1 flex-row py-4">
                <Link
                  to={LocalRoute.InfoForUkrainians}
                  className="hover:underline max-w-xs pr-4 uppercase text-teal-800"
                >
